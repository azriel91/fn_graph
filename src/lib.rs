...
//! fn_graph = { version = "0.11.0", features = ["fn_meta"] }
//! fn_graph = { version = "0.11.0", features = ["interruptible"] }
//! fn_graph = { version = "0.11.0", features = ["resman"] }
//! fn_graph = { version = "0.11.0", features = ["fn_meta", "interruptible", "resman"] }
//! ```
//!
//! # Rationale
//!
